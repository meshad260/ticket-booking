        ...
        <div class="row">
            <div class="col-xs-6">
                ...
                <form method="GET" action="pay.php">
                    ...
                    <input type="number" name="phone" Placeholder="Phone Number" value="<?php echo $row['contact'] ?>"><br>
                    <input type="email" name="email" Placeholder="Enter Email Address" value="<?php echo $row['email'] ?>"><br>
                    <input type="hidden" name="uid" value="<?php echo $row['id'] ?>">
                    <input type="hidden" name="total" Placeholder="Enter Amount" value="<?php echo $total ?>"><br>
